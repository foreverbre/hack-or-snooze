...
/******************************************************************************
 * Story: a single story in the system !!!The blueprint of the
 * house
 */
...
class Story {
   ...
   */
  //special method for assigning properties to an object
...
class StoryList {
  ...
  // }
  //do we change or keep the arguments?
  async addStory(user, { title, author, url }) {
    ...
    const resp = await axios.post(`${BASE_URL}/stories`, newStory);
    //console.log(hi, resp);
  ...
  async removeStory(user, storyId) {
    ...
    //do the same thing for the user's list of stories & their favs
...
class User {
  ...
  /**** Remove a story to the list of user favorites and update
   * the API
